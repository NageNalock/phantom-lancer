...
func (p *agentTaskPool) mcpDataTools() []mcpTool {
	...
	return []mcpTool{
		...
		{Name: mcpToolGetDailyBars, Description: stockAgentMCPToolDescription(mcpToolGetDailyBars), InputSchema: stockAgentMCPToolInputSchema(mcpToolGetDailyBars)},
		{Name: mcpToolGetMinuteBars, Description: stockAgentMCPToolDescription(mcpToolGetMinuteBars), InputSchema: stockAgentMCPToolInputSchema(mcpToolGetMinuteBars)},
		{Name: mcpToolGetQuoteHistory, Description: stockAgentMCPToolDescription(mcpToolGetQuoteHistory), InputSchema: stockAgentMCPToolInputSchema(mcpToolGetQuoteHistory)},
		{Name: mcpToolGetFundFlowHistory, Description: stockAgentMCPToolDescription(mcpToolGetFundFlowHistory), InputSchema: stockAgentMCPToolInputSchema(mcpToolGetFundFlowHistory)},
		{Name: mcpToolGetDecisionEvidence, Description: stockAgentMCPToolDescription(mcpToolGetDecisionEvidence), InputSchema: stockAgentMCPToolInputSchema(mcpToolGetDecisionEvidence)},
		{Name: mcpToolGetMarketScanCandidates, Description: stockAgentMCPToolDescription(mcpToolGetMarketScanCandidates), InputSchema: stockAgentMCPToolInputSchema(mcpToolGetMarketScanCandidates)},
