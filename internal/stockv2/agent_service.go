	...
	return []strategyGenerationPipelineStepDef{
		...
		},
		{
			...
			instructions: []string{
				...
				"When describing action_space, allowed_actions may contain only observe, build_position, add_position, hold, reduce_position, or exit_position. Quote refresh, filing review, order verification, waiting, and later reassessment are observe-rule titles/triggers, never custom action values.",
		...
		},
		{
			...
			objective: "Format the prior pipeline outputs into the final strategy-generation-report/v2.",
			instructions: []string{
				...
				"Rule action is a closed enum: observe, build_position, add_position, hold, reduce_position, or exit_position. Express refresh_quote, review_after_report, verify_orders, monitor_filings, wait, or similar research intentions as action observe with the specific intent in title/trigger; never emit them as custom action values.",
